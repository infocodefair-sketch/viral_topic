...
import { Flame, History, Home, Search, UserRound } from "lucide-react";
...
export function MobileNav() {
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 grid h-16 grid-cols-5 border-t border-white/10 bg-black/90 backdrop-blur-xl md:hidden">
      {items.map((item) => (
